...
locals {
    ...
    install_packages = [
        ...
        "nodejs",
        "docker",
        "patch", # covers older versions of rules_go that depend on system patch; see https://github.com/bazelbuild/rules_go/pull/3617
    ]
...
source "amazon-ebs" "runner" {
  ami_name                                  = "aspect-workflows-al2-cambria-${var.version}"
